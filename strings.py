...
NEW_MATCH = "You have a new texting partner: %s %s"
FINDING_MATCH = "Looking for a match. You'll get a text when one is available!"

PARTNER_ENDED_NEW_MATCH = "Your current partner ended the conversation. \
  We've matched you up with a new partner: %s %s"
